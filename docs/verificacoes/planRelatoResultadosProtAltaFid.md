...
<p align="justify">A <i>Tabela 2</i> a seguir descreve os critérios específicos do artefato de Planejamento do Relato dos Resultados da Avaliação do Protótipo de Alta Fidelidade e informa se está de acordo com o esperado.</p>

| ID | Verificação | Resposta | Foi corrigido? |
| :--: | :-------: | :------: | :------------: |
| 12 | O planejamento inclui os objetivos da avaliação?  | ✔ |  |
| 13 | O planejamento inclui os métodos de avaliação a serem utilizados?  | ✔ |  |
| 14 | O planejamento inclui uma conclusão? | ✔ |  |
| 15 | O planejamento inclui uma problemas encontrados? | ✔ |  |
| 16 | O planejamento inclui envolvidos na avaliação? | ✔ |  |

<figcaption align="center">Tabela 2: Critérios específicos do artefato. (Fonte: Autores, 2022)</figcaption>

## Conclusão
<p align="justify">Não foi possível identificar falhas no artefato</p>

## Histórico de versão
| Versão | Data | Descrição | Autor | Revisor |
| :----: | :--: | :-------: | :---: | :-----: |
| 1.0 | 16/01/2023 | Criação da página | Caio Vitor | Philipe de Sousa |