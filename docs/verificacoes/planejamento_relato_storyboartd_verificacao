...
<p align="justify">A <i>Tabela 2</i> A seguir descreve os critérios específicos do artefato de Planejamento do Relato dos Resultados da avaliação do Storyboard e informa se está de acordo com o esperado.</p>


| ID | Verificação | Resposta | Foi corrigido? |
| :--: | :-------: | :------: | :------------: |
| 12 | Apresenta os problemas encontrados no artefato? | ✔ |  |
| 13 | Ficou definido quais tarefas serão abordadas?  | ✖ |  |
| 14 | Ficou definido qual será o papel dos participantes?  | ✔ |  |
| 15 | Apresenta um resumo de como o planejamento foi guiado?  | ✔ |  |
