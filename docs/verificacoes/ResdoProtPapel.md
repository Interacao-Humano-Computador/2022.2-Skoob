...
<p align="justify">A <i>Tabela 2</i> a seguir descreve os critérios específicos do artefato de Relato dos resultados do Protótipo de Papel e informa se está de acordo com o esperado.</p>

| ID | Verificação | Resposta | Foi corrigido? |
| :--: | :-------: | :------: | :------------: |
| 12 | O planejamento inclui os métodosa serem utilizados?  | ✔ |  |
| 13 | A entrevista  está gravada? | ✔ |  |
| 14 | O documento apresenta os problemas encontrados e a conclusão  | ✔ |  |
...
## Conclusão
<p align="justify">Dentre os defeitos nesse artefato, é o fato te não ter dito um teste piloto antes da avaliação</p>
